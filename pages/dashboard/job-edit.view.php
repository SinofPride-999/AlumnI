...
<head>
    ...
    <title>Edit Job - Alumni Connect</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="../../assets/css/index.css">
    <link rel="stylesheet" href="../../assets/css/jobs.css">
    <link rel="stylesheet" href="../../assets/css/dashboard.css">
    <link rel="stylesheet" href="../../assets/css/job-create.css">
    <link rel="stylesheet" href="../../assets/css/job-edit.css">
</head>
            ...
            <div class="nav-actions">
                ...
                <div class="user-menu">
                    ...
                    <button class="user-avatar" id="userMenuBtn">
                        <img src="<?= htmlspecialchars($user['profile_picture'] ?? 'https://randomuser.me/api/portraits/men/32.jpg') ?>" alt="User avatar">
                    </button>
                </div>
