...
<body class="error-page">
    ...
    <main class="error-content">
        ...
        <div class="error-graphic">
            <div class="error-number animate__animated animate__pulse animate__infinite">404</div>
        </div>
        
        <h1 class="error-title">Oops! Page Not Found</h1>
        <p class="error-message">
            The page you're looking for seems to have graduated and moved on. 
            Maybe it's at a reunion or pursuing new opportunities elsewhere.
        </p>
    ...
    <script>
        // Additional 404 page interactions
        document.addEventListener('DOMContentLoaded', function() {
            // Add ripple effect to 404 number
